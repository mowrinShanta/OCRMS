...
@section('content')
    ...
    <form action="{{route('admin.notices.update',$notice->id)}}" enctype= "multipart/form-data"  method="POST">
        ...
        <div class="mb-3">
            ...
            <input value="{{$notice->date}}" name="date" type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"required>
        ...
        <div class="mb-3">
            ...
            <input value="{{$notice->work}}" type="text"  name="work"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"required>
        </div>
