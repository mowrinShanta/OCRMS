        ...
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    ...
                    <form action="{{route('user.registration.storage')}}" method="post"> 
                        @csrf                          
                         <h3 class="text-center text-info">Registration</h3>
                            ...
                            <div class="form-group">
                                <label for="password" class="text-info">Cell:</label><br>
                                <input type="text" name="cell" id="password" class="form-control">
                            </div>
                            <div class="form-group">
