...
<div class="cont_ba_opcitiy">
        ...
        <h2>ADMIN</h2>  
  <p>Click here to go admin pannel</p> 
  <!-- <button class="btn_login" onclick="cambiar_login()">Admin</button> -->
...
<div class="cont_ba_opcitiy">
  ...
  <p>Click here to go citizen pannel</p>

  <a href="{{route('user')}}" class="btn btn-danger">Citizen</a>
</div>
  </div>
       </div>
